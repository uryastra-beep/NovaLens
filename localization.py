...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "english": {
        ...
        "report_opened": "Bug-report draft opened in your browser.",
        "report_open_failed": "I could not open the bug-report page.",
        "done": "Done",
    ...
    "spanish": {
        ...
        "report_opened": "Abrí el borrador del reporte en tu navegador.",
        "report_open_failed": "No pude abrir la página para informar el error.",
        "done": "Listo",
