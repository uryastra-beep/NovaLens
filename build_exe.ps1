...
$packArguments = @(
    ...
    "--hidden-import", "popup", "popup_exe", "config", "multimodal", "audio_indicator", "bubble_layout", "control_bubble", "restart_prompt", "runtime_control", "screen_selector", "localization", "app_info", "popup_layout", "reporting",
    "--add-data", "popup.py;.", "popup_exe.py;.", "config.py;.", "multimodal.py;.", "audio_indicator.py;.", "control_bubble.py;.", "restart_prompt.py;.", "assets\NovaLens.png;assets"
)
