...
NovaLens necesita una API key de Google Gemini.

Creá un archivo llamado `.env` dentro de la carpeta principal del proyecto:
...
Nunca publiques ni compartas el archivo `.env`.
...
En este modo NovaLens se ejecuta sin mostrar una terminal.
